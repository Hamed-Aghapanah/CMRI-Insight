...
bb_enable_modelss1=['resnet50' , 'none']
dual_attention_enable_modelss1=['vsc ','vs  ','v c ',' sc ', 'v   ','  c ',' s  ','none',]
...
if  ablation_study:
    ...
    for mode in modes:
        ...
        for k_fold in range(9,k_folds):
            ...
            if demo:
                X_train0=X[:5];Y_train10=Y1[:5];
                Y_train20=Y2[:5];Y_train30=Y3[:5]
                
                X_valid0=X[:5];Y_valid10=Y1[:5];
                Y_valid20=Y2[:5];Y_valid30=Y3[:5]
                
                X_test0=X[:5];Y_test10=Y1[:5];
                Y_test20=Y2[ :5];Y_test30=Y3[:5]
            ...
            # =============================================================================
                        ...
                        if loss_N==1:
                            ...
                            files_s2 = os.listdir('loading_segmentation_model')
                            ...
                            for  epoch0 in range(last_saved_epoch-1 , last_saved_epoch):
                                print(epoch0)
                                ...
                                # ssss
                                for file_indexxx in range(len (files_s2)):
                                    try:
                                        weights_name_temp = 'loading_segmentation_model/'+files_s2 [file_indexxx]
                                        model.load_weights(weights_name_temp)
                                        ...
                                        if show_save_result_every_epochs:
                                            # index=5
                                            s= saver_result (model,X_train0,Y_train10,Y_train20,Y_train30,index001_train,path_name_save_every_epoch,current_epoch ,'train weight_name ='+str(files_s2 [file_indexxx]) + '      i_vsc = '+i_vsc +'   , mode='+mode)    
                                            s= saver_result (model,X_valid0,Y_valid10,Y_valid20,Y_valid30, index001_val,path_name_save_every_epoch,current_epoch ,'validate weight_name ='+str(files_s2 [file_indexxx]) + '     i_vsc = '+i_vsc +'   , mode='+mode)    
                                            s= saver_result (model,X_test0,Y_test10,Y_test20,Y_test30,index001_test,path_name_save_every_epoch,current_epoch ,'Test  weight_name = '+str(files_s2 [file_indexxx]) + '      i_vsc = '+i_vsc +'   , mode='+mode)    
                                            ...
                                            good_h5.append(files_s2 [file_indexxx])
                                            good_h5_res.append( s)
                                    except:
                                        CCCCCCCCCCCCC=CCCCCCCCCCCCC+1
                                        print(CCCCCCCCCCCCC)
                    # os.startfile(path_name_save_every_epoch)
