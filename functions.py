"""   Created on Thu May 18 19:24:39 2023
...
def pushButtonLanguage_function(self):
    ...
    if lan0=='English':
        ...
        self.ui.load_models.setText('load models')                       
...
def loadimage_function(self):
    ...
    if fname[0] !='':
        ...
        for font1 in range (step_phase2):
            for rep in range(2):
                f1=512 / np.shape(image0) [0] * font1/step_phase2
                f2=200 / np.shape(image0) [0] * font1/step_phase2
