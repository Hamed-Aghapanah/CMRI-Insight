...
class MyForm(QMainWindow):
    def __init__(self):
        ...
        # self.ui.actionclassifier2.triggered.connect(self.applyclassification_function)
        # self.ui.actionclassifier3.triggered.connect(self.applyclassification_function)
    ...
    def pushButtonLanguage_function(self):
        ...
        if lan0=='English':
            ...
            languager=['Load Image','DICOM','load mask',' Images + Masks','Zoom','Crop' ,
                  ...
                  'Full Screen',
                  'Created by Hamed Aghapanah    Isfahan University of Medical Science     Version 2 , 2023',
        ...
        if lan0=='French':
            ...
            languager=['Charger l image','DICOM','charger le masque',' Images + Masques','Zoom','Rogner' ,
                               ...
                               'Plein écran',
                               'Créé par Hamed Aghapanah Isfahan University of Medical Science Version 2, 2023',
        ...
        if lan0=='Germany':
            ...
            languager=['Bild laden', 'DICOM', 'Maske laden', 'Bilder + Masken', 'Zoom', 'Zuschneiden' ,
                               ...
                               'Ganzer Bildschirm',
                               'Erstellt von Hamed Aghapanah Isfahan University of Medical Science Version 2, 2023',
        ...
        if lan0=='Hindustani':
            ...
            languager=['लोड इमेज', 'डीकॉम', 'लोड मास्क', 'इमेज + मास्क', 'ज़ूम', 'क्रॉप',
                   ...
                   'पूर्ण स्क्रीन',
                   'हमीद अघपनाह इस्फ़हान यूनिवर्सिटी ऑफ़ मेडिकल साइंस संस्करण 2, 2023 द्वारा बनाया गया',
        ...
        if lan0=='Chinese':
            ...
            languager=['加载图片','DICOM','加载掩码','图片+面具','缩放','裁剪',
                               ...
                               '全屏',
                               '由 Hamed Aghapanah Isfahan 医科大学创建,第 2 版,2023 年',
                               '背景','颜色','方框','字体',
                               '扩张型心肌病 (DCM)',
                               '肥厚性心肌病 (HCM)',
                               '心肌梗塞 (MI)',
        ...
        if lan0=='Spanish':
            ...
            languager=['Cargar imagen','DICOM','cargar máscara','Imágenes + Máscaras','Zoom','Recortar' ,
                   ...
                   'Pantalla completa',
                   'Creado por Hamed Aghapanah Isfahan University of Medical Science Versión 2, 2023',
        ...
        if lan0=='العربیه':
            ...
            languager=['تحميل الصورة' , 'DICOM' , 'تحميل القناع' , 'الصور + الأقنعة' , 'تكبير' , 'اقتصاص' ,
                               ...
                               'تكبير الشاشة',
                               'من إعداد حامد أغابانا , جامعة أصفهان للعلوم الطبية , الإصدار الثاني , 2023' ,
        ...
        if lan0=='Malay':
            ...
            languager=['Muat Imej','DICOM','muat topeng',' Imej + Topeng','Zum','Pangkas' ,
                   ...
                   'Skrin penuh',
                   'Dicipta oleh Universiti Sains Perubatan Hamed Aghapanah Isfahan Versi 2 , 2023',
        ...
        if lan0=='Russian':
            ...
            languager=['Загрузить изображение','DICOM','загрузить маску','Изображения + маски','Масштаб','Обрезать',
                               ...
                               'Полноэкранный',
                               'Создано Хамедом Агапанахом Исфаханским университетом медицинских наук, версия 2, 2023 г.',
        ...
        if lan0=='italian':
            ...
            languager=['Carica immagine','DICOM','carica maschera',' Immagini + Maschere','Zoom','Ritaglia' ,
                   ...
                   'A schermo intero',
                   'Creato da Hamed Aghapanah Isfahan University of Medical Science Version 2 , 2023',
        ...
        if lan0=='فارسی':
            ...
            languager=[  'بارگیری تصویر', 'دایکام', 'بارگذاری ماسک', 'تصاویر + ماسک‌ها', 'زوم', 'برش',
                           ...
                           'تمام صفحه',
                           'ایجاد شده توسط دانشگاه علوم پزشکی حامد آقا پناه اصفهان نسخه 2  2023',
        ...
        if lan0=='Dutch':
            ...
            languager=['Afbeelding laden','DICOM','masker laden',' Afbeeldingen + maskers','Zoom','Bijsnijden',
                   ...
                   'Volledig scherm',
                   'Gemaakt door Hamed Aghapanah Isfahan University of Medical Science Versie 2, 2023',
...
#            if deep_switch ==0:
        ...
        if classifer == 'classifier2 on Deep Features':
            s=1
            print ('classifier2 on Features')
            print('deep_switch = ',self.deep)
            #self.ui.label_class.setText('classifier2 Method :)')
            self.ui.status.setText('classifier2 Method :)')
 
        if classifer == 'classifier3 on Deep Features':
            s=1
            print ('classifier3 on Features')
            print('deep_switch = ',self.deep)
            #self.ui.label_class.setText('classifier3 Method :)')
            self.ui.status.setText('classifier3 Method :)')
...
# =============================================================================
    def dispAmount2(self):
        ...
        if amount2==2:
            classifer='classifier2 on Deep Features'
        if amount2==3:
...
#        dim2 = (640, 480)
    ...
    def language_function(self,languager):
        ...
        # self.ui.author_7.setText(languager[cnt]);cnt=cnt+1 
    ...
    def color_b_function(self,blocks,color):
        for i in blocks:
            try:
                eval('self.ui.'+i+'.setStyleSheet("QWidget { background-color:'+color+'}")')
    ...
    def stage_function(self,stage):
        ...
        if self.stage >1:
            ...
            self.ui.classifier1.setEnabled(True)
            self.ui.classifier2.setEnabled(True)
            self.ui.classifier3.setEnabled(True)
