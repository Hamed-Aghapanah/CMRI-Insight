...
#  def
# =============================================================================
def Grad_CAM (model,X,index=2,tavan=1, tavan2=1 , smoothed=True,alpha=0.4,alpha2=0.6):
    ...
    plt.subplot(2,3,5);plt.imshow(superimposed_img ) # plt.figure();plt.imshow(superimposed_img2 ) 
