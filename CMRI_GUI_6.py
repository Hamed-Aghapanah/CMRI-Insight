    ...
    def pushButtonLanguage_function(self):
        ...
        if lan0=='فارسی':
            ...
            languager=[  'بارگیری تصویر', 'دایکام', 'بارگذاری ماسک', 'تصاویر + ماسک‌ها', 'زوم', 'برش',
                           ...
                           'تمام صفحه',
                           'تهیه شده توسط حامد آقا پناه دانشگاه علوم پزشکی  اصفهان نسخه 2  2023',
...
# ============================================================================= 
    ...
    def load_mask_function(self):
        ...
        self.ui.status.setText(' Mask is loaded '+ str(np.size(MASK)))
        self.mask_function(MASK)
...
#       stage 3 
    ...
    def cal_res1_function(self):
        ...
        if np.size(self.mask)==0:   ##  no mask 
...
#        dim2 = (640, 480)
    ...
    def mask_function(self,image0):
        ...
        scene = QtWidgets.QGraphicsScene()
        scene.addPixmap(pixmap)
        self.ui.fig_mask.setScene(scene)
